...
-- Assumption: each digit in a binary string will INCREASE in weight by a factor of 2
-- ie: 1011 = (1*1) + (0*2) + (1*4) + (1*8) = 13
...
-- (3) Convert bits to byte (ie: right pad with zeros to 8 bits)
bits2byte :: [Bit] -> [Bit]
